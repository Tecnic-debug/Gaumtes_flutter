...
class _LoginScreenState extends State<LoginScreen> {
  ...
  loginNow() async{
    ...
    if(currentUser != null){
       readlocally(currentUser!).then((value) {
         Navigator.pop(context);
  ...
  Future readlocally(User currentUser) async
  {
    await  FirebaseFirestore.instance.collection("orders").doc(currentUser.uid)
        .get().then((snapshot) async{
          await sharedPreferences!.setString("uid", currentUser.uid);
          await sharedPreferences!.setString("email", snapshot.data()!["SellerEame"]);
